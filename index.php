   ...
   <body>
               ...
               <ul class="rslides" id="slider4">
                     ...
                     <div class="slider-img one-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5>Every piece tells a story take one home today</h5>
                              <div class="bottom-info">
                                 <p>Art transcends time, but it takes vision to bring it to life—let our gallery management be the bridge between creativity and those who cherish it."</p>
                              </div>
                  ...
                  <li>
                     <div class="slider-img two-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5>Art is an investment in emotion,creativity, and beauty</h5>
                              <div class="bottom-info">
                                 <p>Art transcends time, but it takes vision to bring it to life—let our gallery management be the bridge between creativity and those who cherish it."</p>
                              </div>
                              <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="slider-img three-img">
                        <div class="container">
                           <div class="slider-info">
                              <h5>Own a piece of imagination—let art enrich your life.</h5>
                              <div class="bottom-info">
                                 <p>Art transcends time, but it takes vision to bring it to life—let our gallery management be the bridge between creativity and those who cherish it."</p>
                              </div>
                              <div class="outs_more-buttn">
      ...
      <section class="about py-lg-4 py-md-3 py-sm-3 py-3" id="about">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            <h3 class="title text-center mb-lg-5 mb-md-4  mb-sm-4 mb-3">Best Art Products</h3>
